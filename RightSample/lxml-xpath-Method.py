# -*- coding: utf-8 -*-
# @Time : 2020/2/24 下午4:09
# @Author : www.Andy.ge
# @FileName: lxml-xpath-Method.py   批量下载福利图，用了现在不理解的方法xpath路径
# @Software: Python3 @ PyCharm
# @Blog ：项目地址 https://www.cnblogs.com/girliswater/p/11152942.html
"""
学习经验：
1.面向对象的方法设置class，但是不利于调试啊？
